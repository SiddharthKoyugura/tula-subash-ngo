...
function animateSequence() {
    for (var n = document.getElementsByClassName("sequence"), a = 0; a < n.length; a++) {
        ...
        for (l = 0; l < t.length; l++)
            " " != t[l] ? (i += '<span style="animation-delay:' + m + "ms; -moz-animation-delay:" + m + "ms; -webkit-animation-delay:" + m + 'ms; ">' + t[l] + "</span>",
            m += 150) : i += t[l];
        e.innerHTML = i
    }
}
function animateRandom() {
    for (var n = document.getElementsByClassName("random"), a = 0; a < n.length; a++) {
        ...
        for (l = 0; l < m.length; l++) {
            var s = ""
              , d = m[l];
            " " != t[d] ? (s = '<span style="animation-delay:' + i + "ms; -moz-animation-delay:" + i + "ms; -webkit-animation-delay:" + i + 'ms; ">' + t[d] + "</span>",
            o[d] = s) : o[d] = t[d],
            i += 80
        }
        o = o.join(""),
